...
func (a *API) TraceTransaction(hash common.Hash, config *backend.TraceConfig) (interface{}, error) {
...
func (a *API) TraceBlockByNumber(height rpctypes.BlockNumber, config *backend.TraceConfig) ([]*evmtypes.TxTraceResult, error) {
...
// EVM and returns them as a JSON object.
func (a *API) TraceBlockByHash(hash common.Hash, config *backend.TraceConfig) ([]*evmtypes.TxTraceResult, error) {
